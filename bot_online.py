...
def g4f_with_timeout(txt, username, timeout=20):
    ...
    messages = [
        {"role": "system", "content": "ты белый кролик из Алисы в стране чудес, взрослый психоделический персонаж. ты мой друг. ответь по-русски, "
                                      ...
                                      "разнообразь с помощью эмодзи, но не слишком много, в том числе"
